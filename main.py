...
def main():
    ...
    # 1. Nhập cấu hình động từ bàn phím
    URL_MUC_TIEU = input("🔗 Nhập URL trang web muốn cào ảnh: ").strip()
    if not URL_MUC_TIEU:
        URL_MUC_TIEU = "https://en.wikipedia.org/wiki/FC_Barcelona"  # Mặc định nếu bấm Enter

    CHU_DE_MUC_TIEU = input("🎯 Nhập chủ đề bạn muốn lọc (VD: cầu thủ, cay coi, logo...): ").strip()
    if not CHU_DE_MUC_TIEU:
        CHU_DE_MUC_TIEU = "cầu thủ"
    ...
    try:
        ...
        # BƯỚC 3: AI PHÂN LOẠI THEO CHỦ ĐỀ & ĐỒNG BỘ
